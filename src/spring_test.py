...
class TestProjection(unittest.TestCase):
    def test_compressed(self):
        ...
        c = spring.Spring(k=1, L=1, p0=lambda: p0)
    ...
    def test_p0_moved(self):
        ...
        p0_lst = [np.copy(p0)]
        q = np.array([1, 0, 0])
        c = spring.Spring(k=1, L=1, p0=lambda: p0_lst[0])
    ...
    def test_different_orientations(self):
        ...
        L = np.sqrt(3)
        c = spring.Spring(k=1, L=L, p0=lambda: p0)
        np.testing.assert_array_almost_equal(
            c.project(q), want_p)
...
class TestParamters(unittest.TestCase):
    def test_parameters(self):
        ...
        c = spring.Spring(k=k, L=L, p0=lambda: p0)
        ...
        c = spring.Spring(k=k, L=L, p0=lambda: p0, w=w, A=A, B=B)
